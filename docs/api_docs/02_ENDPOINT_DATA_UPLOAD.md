...
| ------------ | ------ | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `project_id` | string | Yes      | Unique identifier for the project. Must be alphanumeric. If the project doesn't exist, it will be created automatically. Project IDs `1` through `5` are reserved for system collections. |
